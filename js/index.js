...
function showcart() {
  ...
  for (var i = 0; i < object.length; i++) {
    ...
    if (object[i].qatuntiy != 0) {
      showcart += ' <li class="clearfix"><img src="img/' + object[i].image + '" alt="item1" style="width: 20%;height: 60px;" /><span class="item-name">';
      showcart += object[i].proname;
      showcart += '</span><span class="item-price" style="font-size:14px;">PRK :';
      showcart += object[i].price;
      showcart += '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="Remove(' + i + ')"><i class="fa fa-window-close"></i></a><br><span class="item-quantity" style="font-size:12px;">Quantity :';
